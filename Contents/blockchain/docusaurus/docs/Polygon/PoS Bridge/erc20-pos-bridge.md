# How to transfer ERC-20 tokens to the Polygon (Matic) chain
...
This article was published [here](https://learn.figment.io/tutorials/transferring-tokens-with-polygon-pos-bridge)
...
* [Transfer using SDK](#transfer-using-sdk)
  * [Providers](#providers)
  * [Installing helpers](#installing-helpers)
  * [Approve](#approve)
  * [Deposit](#deposit)
  * [Not able to run main.js](#Not-able-to-run-main.js)
...
![mumbai](images/erc20-pos-mumbai.png)
...
* Choose **Gorli Testnet -> Mumbai testnet**
 ...
 ![map image](images/erc20-pos-map.png)
...
![mapped image](images/erc20-pos-mapped.png)
...
![metamask after map](images/erc20-pos-metamask-after-map.png)

We don't yet have any MLB tokens in Mumbai. We can transfer some across the bridge and check our Metamask balance again afterward.
...
The expected output for **approveERC20ForDeposit** is something like this:
...
* `amount`: the amount of **token** we want to transfer. By default, the **open zeppelin** V4 `ERC20` contract uses a value of **18** for **decimals**. That is why **999** is multiplied by **(10** 18)**
...
![MLB Metamask](images/erc20-MLB-token.png)
...
2. Make sure Ethereum Mainnet is selected in Metamask
 ...
 ![Metamask Ethereum](images/erc20-pos-metamask-eth-mainnet.png)
...
4. You will be asked to sign a **Signature Request** to make sure you have access to the wallet. It costs no fees
 ...
 ![pos web ui login](images/erc20-pos-web-ui-login.png)

5. I chose `DAI` token from Ethereum

 ![DAI](images/erc20-pos-web-ui-dai.png)
...
7. Then review the transaction details, like gas fees and the smart contract you are sending tokens to - before clicking on **Confirm**
 ...
 ![transfer](images/erc20-pos-web-ui-transfer.png)
